...
如果你希望使用本地 Mac 來觸發 GitHub Actions，而不依賴 GitHub 的 schedule：
...
本地排程器的詳細說明請參考：[scheduler/local/docs/README.md](scheduler/local/docs/README.md)
